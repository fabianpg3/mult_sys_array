...
#define XMMULT_CONTROL_R_ADDR_A_DATA 0x10
#define XMMULT_CONTROL_R_BITS_A_DATA 64
#define XMMULT_CONTROL_R_ADDR_B_DATA 0x1c
#define XMMULT_CONTROL_R_BITS_B_DATA 64
#define XMMULT_CONTROL_R_ADDR_C_DATA 0x28
#define XMMULT_CONTROL_R_BITS_C_DATA 64
