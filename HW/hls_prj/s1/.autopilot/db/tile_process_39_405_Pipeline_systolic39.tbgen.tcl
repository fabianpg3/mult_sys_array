set moduleName tile_process_39_405_Pipeline_systolic39
set isTopModule 0
...
set C_modelName {tile_process.39.405_Pipeline_systolic39}
...
set C_modelArgMapList {[ 
	{ "Name" : "select_ln116_3", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sext_ln133_13", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln133_13 sc_in sc_lv 8 signal 12 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln133_13", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "sext_ln133_13", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8s_8s_16ns_16_4_1_U106", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8s_8s_16ns_16_4_1_U107", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8s_8s_16ns_16_4_1_U108", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_8s_8s_16ns_16_4_1_U109", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sext_ln133_13 { ap_none {  { sext_ln133_13 in_data 0 8 } } }
}
