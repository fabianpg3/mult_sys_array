...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_b_col_c23 \
    op interface \
    ports { b_col_c23_din { O 32 vector } b_col_c23_num_data_valid { I 3 vector } b_col_c23_fifo_cap { I 3 vector } b_col_c23_full_n { I 1 bit } b_col_c23_write { O 1 bit } } \
} "
}
