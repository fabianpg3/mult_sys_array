...
"SubInsts" : [
	...
	{"Name" : "Loop_readA_proc_U0","ID" : "2","Type" : "sequential",
		"SubInsts" : [
		{"Name" : "grp_Loop_readA_proc_Pipeline_readA_fu_4188","ID" : "3","Type" : "sequential",
			"SubLoops" : [
			{"Name" : "readA","ID" : "4","Type" : "pipeline"},]},]},
	{"Name" : "Loop_readB_proc_U0","ID" : "5","Type" : "sequential",
		"SubInsts" : [
		{"Name" : "grp_Loop_readB_proc_Pipeline_readB_fu_4178","ID" : "6","Type" : "sequential",
			"SubLoops" : [
	...
	{"Name" : "Loop_tile_processing_proc_U0","ID" : "8","Type" : "sequential",
		...
		"SubInsts" : [
		{"Name" : "grp_Loop_tile_processing_proc_Pipeline_systolic1_systolic2_fu_20586","ID" : "10","Type" : "sequential",
				"SubLoops" : [
